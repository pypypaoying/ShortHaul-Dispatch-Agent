...
def render() -> None:
    ...
    label(draw, (42, 101), "智能接入并运行", FONT_16)
    label(draw, (42, 148), "上传一批业务表 / 粘贴数据，Agent 自动对齐模型输入", FONT_13, "#667085")
    input_box(draw, (42, 178, 410, 216), "attachment_1.xlsx, attachment_2.csv ...")
