...
![ShortHaul Dispatch Agent framework](docs/assets/shorthaul_agent_framework.png)

架构图矢量版：[shorthaul_agent_framework.svg](docs/assets/shorthaul_agent_framework.svg)
